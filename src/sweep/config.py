...
SWEEP_RESULT_FIELDNAMES = [
    ...
    # Autoregressive rollout metrics (val split only)
    "val_rollout_mse",
    "val_rollout_l2",
    "val_rollout_mse_channels",
    "val_rollout_l2_channels",
    "val_rollout_n_runs",
    "val_rollout_n_steps",
    "val_rollout_state_channels",
    "val_rollout_channel_names",
    "val_rollout_artifact_npz",
    "val_rollout_artifact_plot",
    # Autoregressive rollout metrics (train split)
    "train_rollout_mse",
    "train_rollout_l2",
    "train_rollout_mse_channels",
    "train_rollout_l2_channels",
    "train_rollout_n_runs",
    "train_rollout_n_steps",
    "train_rollout_artifact_npz",
    "train_rollout_artifact_plot",
    "epochs",
    "eval_every",
    "batch_size",
    "learning_rate",
...
SWEEP_PER_SCENARIO_RESULT_FIELDNAMES = [
    ...
    "train_plot",
    "val_plot",
    # Per-scenario autoregressive rollout metrics
    "val_rollout_mse",
    "val_rollout_l2",
    "val_rollout_mse_channels",
    "val_rollout_l2_channels",
